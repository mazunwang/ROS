#ifndef _STATE_COM_MOVE_H_
#define _STATE_COM_MOVE_H_
...
class State_COM_Move:public State_Base{
public:
    State_COM_Move(LegController* _leg,ControlParameters* _qua,StateEstimatorContainer* container):State_Base(_leg,_qua,container),
    Leg_Pos_Init(4),
