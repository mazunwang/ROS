#ifndef _STATE_UNLOADFORCE_H_
#define _STATE_UNLOADFORCE_H_

#include"State_Base.h"

class State_UnloadForce:public State_Base{
public:
    State_UnloadForce(LegController* _leg,ControlParameters* _qua,StateEstimatorContainer* container):State_Base(_leg,_qua,container),
    Leg_Pos_Init(4),
